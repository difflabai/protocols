...
**Status:** v1.0.0-draft | [Full Specification](spec/v1/specification.md) | [Example Project](examples/web-app/.project/)
...
See the [example AGENTS.md](examples/web-app/AGENTS.md) for the pointer pattern.

## Repository Structure

```
spec/v1/specification.md          # Full specification (RFC 2119)
schemas/v1/                       # Optional JSON schemas for frontmatter validation
examples/web-app/                 # Complete working example
```
...
*A [Differential AI Lab](https://github.com/difflabai) protocol.*
